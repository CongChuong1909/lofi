    ...
    return (
        <>
           <div className='flex flex-col justify-center items-center bg-[rgba(1,1,1,0.7)] rounded-[10px] z-[2] absolute w-10 right-10 bottom-[40%] '>
                ...
                <i className=" cursor-pointer text-[#fff] fa-duotone fa-timer px-4 py-6 text-[18px]"></i>
                <i className=" cursor-pointer text-[#fff] fa-sharp fa-solid fa-image px-4 py-6 text-[18px]"></i>
